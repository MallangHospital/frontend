...
function populateForm(notice) {
  ...
  document.getElementById('noticeWriter').value = notice.noticeWriter;
  document.getElementById('password').value = notice.password; // 작성자
...
function updateNotice(id) {
  ...
  fetch(`https://mallang-a85bb2ff492b.herokuapp.com/api/notice/${id}`, {
    ...
    .then((message) => {
      showModal('공지사항이 성공적으로 수정되었습니다!', function () {
